...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('DB_SVC_SERVICE_HOST'),
        'PORT': '',
    }
}
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            "hosts": [(os.environ.get('REDIS_SERVICE_HOST'), 6379)],
        },
    },
}
...
STATIC_URL = '/static/'
STATIC_ROOT = '/home/staticdir/repo/static'

MEDIA_ROOT = '/home/staticdir/repo/media'
MEDIA_URL = '/media/'
